...
<script type="text/javascript">
	...
	if (secondStats == "Open") {
		...
		selcPara.innerHTML = "<i class = 'fad fa-box'></i>"+secondStats;
	...
	if (staff != "Not Assigned") {
		...
		var messageKey = reportID+"-"+troubleshooterID;
		var msgObjNum = 0;
		// alert(messageKey);
		if (secondStats == "Open") {
		...
		function sendMail(staffMail,staffName,reporterName,facilName,stats){
								...
								<td colspan = "2" align="center"  style = "background-color:white; border:.5px solid rgba(0, 0, 0, .0);">
									<p style="width:90%; height:90%;" align="left">
										...
										<span style="font-size:clamp(13px, 1.2vw, 20px); line-height:1.6;">
											An issue that you solved at `+facilName+` unfortunately have resurface again, `+reporterName+` is seeking for your assistance once more, Please start working on it as soon as possible<br><br>Thank you For Your Assistance
										</span>
									</p>
								</td>
							</tr>
