...
<body>
	...
	<form action="tracking-inc.php" method="POST">
				...
				<div class="inputCont">
					...
					<div class="inputContainer">
						<span class="label" onclick="inputFocus(2)" id="label2">
							...
							<p>Enter Temporary Password</p>
						</span>
						<span class="input">
							<input type="text" id="input2" onfocus="inputFocus(2)">
							
						</span>
					</div>

					<div class="buttonContainer">
						<button type="button" name="tempSign" id="signIn">Login <i class="fad fa-right-to-bracket"></i></button>	
					</div>
				</div>
			</div>
		</div>
		<div class="banner2">
			...
			<div class="errorMSG">
				<span>
					<i class="fad fa-check-to-slot"></i>
...
<script type="text/javascript">
	...
	function showError(errorNum) {
		...
		var errorSpan = document.querySelector(".errorMSG span");
		...
		var errorContAppear = setInterval(() => {
			if (counter > 0) {
				...
				errorSpan.style.transition = "all .5s ease .3s";

				errorSpan.querySelector("p").innerHTML = "Account Created. Setup Your Password";
			}
		},500)
	...
	document.getElementById("signIn").addEventListener("click", () => {
		...
		xhttp.onload = function () {
			...
			document.querySelector(".inputCont").innerHTML = this.responseText;
		}
		xhttp.open("POST","tracking-inc.php");
		xhttp.setRequestHeader("Content-type","application/x-www-form-urlencoded");
		xhttp.send("TempPass="+pass)
	})
</script>
</html>